  ...
  return (
    <section className="m-8 w-full p-6 rounded-lg max-w-2xl shadow-lg bg-white">
      <header className="flex items-center">
        ...
        <h3 className="font-medium text-lg">Demography</h3>
      </header>
        ...
        <div className="flex items-center py-3">
          ...
          <div className="flex-1">
            <div className="flex items-center">
              ...
              <span className="px-2 py-1 rounded-lg bg-red-50 text-orange-500 text-xs">38th</span>
            </div>
            <p className="">38,781,291</p>
          </div>
        </div>
        <div className="flex items-center py-3">
          <span className="w-8 h-8 shrink-0 mr-4 rounded-full bg-blue-50 flex items-center justify-center">
          ...
          <div className="flex-1">
            <div className="flex items-center">
              ...
              <span className="px-2 py-1 rounded-lg bg-red-50 text-green-500 text-xs">238th</span>
            </div>
            <p className="">4 /km^2</p>
          </div>
        </div>
        <div className="flex items-center py-3">
          <span className="w-8 h-8 shrink-0 mr-4 rounded-full bg-blue-50 flex items-center justify-center">
          ...
          <div className="flex-1">
            <div className="flex items-center">
              ...
              <span className="px-2 py-1 rounded-lg bg-red-50 text-orange-500 text-xs">121th</span>
            </div>
            <p className="">0.73%</p>
          </div>
        </div>
...
export default DemographyInfoCard;
